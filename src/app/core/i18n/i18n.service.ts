...
const TEXT: Record<AppLanguage, Record<string, string>> = {
  uk: {
    ...
    'play.hint': 'Утримуй стрілки, щоб рухатися',
    'controls.left': 'Рухатися ліворуч',
    'controls.right': 'Рухатися праворуч',
    'hud.score': 'Рахунок',
    'hud.time': 'Час',
    'hud.round': 'Раунд',
    'hud.lives': 'Життя',
    ...
    'overlay.instructions': 'Утримуй кнопки зі стрілками, лови відходи та уникай батарейок.',
    ...
    'overlay.gameOver': 'Гру завершено',
    'overlay.counting': 'Підраховуємо результат…',
    'overlay.nextRound': 'Наступний раунд',
    'overlay.getReady': 'Кузов розвантажено. Приготуйся!',
    'overlay.points': 'очок',
  ...
  en: {
    ...
    'game.playAria': 'Play',
    'play.hint': 'Hold the arrows to move',
    ...
    'overlay.instructions': 'Hold the arrow buttons, catch waste, and avoid batteries.',
    ...
    'overlay.gameOver': 'Game complete',
    'overlay.counting': 'Calculating your result…',
    'overlay.nextRound': 'Next round',
    'overlay.getReady': 'The truck is empty. Get ready!',
