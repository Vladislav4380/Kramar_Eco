...
@Component({ selector: 'app-catch-trash-page', imports: [GameFieldComponent, GameHudComponent, GameOverlayComponent, GameControlsComponent], providers: [CatchTrashStore], templateUrl: './catch-trash-page.component.html', styleUrl: './catch-trash-page.component.scss', changeDetection: ChangeDetectionStrategy.OnPush })
